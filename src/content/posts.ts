...
export const posts: Post[] = [
  {
    ...
    excerpt: {
      pt: "A nova era da busca exige substância: conteúdo proprietário, autoridade construída e gestão ativa de reputação. Por que pós-venda virou alavanca de aquisição em serviços financeiros.",
      en: "The new search era demands substance: proprietary content, actively built authority, and active reputation management. Why post-sale became an acquisition lever in financial services.",
    },
    date: "2026-05-11",
    readingTime: 6,
    body: {
      pt: [
        p("Por anos, o jogo de growth digital teve uma lógica clara: comprar cliques, mensurar conversão, otimizar custo de aquisição. Marca era topo de funil; performance era fundo. Quem dominava as duas operações em silos paralelos sobrevivia bem."),
        p("Esse jogo está acabando. A substituição vem do próprio mecanismo de busca. Quando o consumidor pergunta pra uma IA \"qual a melhor conta digital pra quem viaja?\" em vez de digitar a mesma pergunta no Google, três coisas mudam ao mesmo tempo: o intermediário entre marca e cliente vira um modelo de linguagem, a resposta vira uma única recomendação em vez de uma página de resultados, e a decisão de qual marca aparecer ali depende de critérios que ninguém ainda sabe leiloar."),
        p("Há uma assimetria crescente entre pesquisa humana e pesquisa mediada por agentes. Humanos cansam, comparam três ou quatro opções, escolhem com base no que está mais visível. Agentes processam dezenas de fontes em segundos, ponderam reputação, cruzam termos de contrato, e devolvem uma recomendação. Conforme essa diferença fica óbvia pra mais consumidores, mais decisões migram pra interface conversacional. Não é projeção: pesquisa recente da McKinsey aponta que instituições financeiras que dominaram a otimização pra esses modelos — disciplina nova chamada Generative Engine Optimization, ou GEO — viram crescimento de até seis vezes em tráfego orgânico não pago."),
        quote(
        ...
        p("Aqui está o ponto que ainda não foi internalizado pela maioria dos comitês de marketing: pós-venda virou alavanca de aquisição. A lógica é direta. Se o cliente reclama publicamente do seu banco, essa reclamação vira texto indexável. Se a IA é treinada nesse texto, ela aprende a associar sua marca a problemas específicos. Quando outro cliente potencial perguntar \"qual o melhor banco pra X\", o modelo pondera a reputação observada."),
        p("Isso reorganiza o cálculo de unit economics. Antes, um cliente mal-atendido custava o LTV perdido daquele cliente, mais boca-a-boca negativo numa rede pequena. Agora soma-se um terceiro custo: degradação de visibilidade orgânica em IA pra novos clientes potenciais. O CAC do próximo cliente sobe porque o atendimento do anterior foi ruim."),
        p("Pra setor financeiro, isso é especialmente urgente. Bancos e fintechs estão entre as empresas mais reclamadas do país por construção: alta volumetria de transações, situações emocionalmente carregadas, e SAC frequentemente subdimensionado. O argumento de que \"investir em CS não tem ROI claro\" perdeu validade. O ROI passou a estar em dois lugares ao mesmo tempo: na retenção do cliente atual e no posicionamento orgânico junto a modelos de IA."),
        p("Acionável: trate pós-venda como linha de receita. Em serviços financeiros, vale considerar se o orçamento de SAC está dimensionado pro volume de transações e pra complexidade do produto. Se não está, esse é provavelmente o investimento de growth com maior retorno marginal nos próximos seis meses, e talvez o único cujo retorno aparece em duas linhas do P&L ao mesmo tempo."),
      ...
      en: [
        p("For years, digital growth had a clear logic: buy clicks, measure conversion, optimize acquisition cost. Brand was top of funnel; performance was bottom. Companies that dominated both in parallel silos did well."),
        p("That game is ending. The replacement comes from the search mechanism itself. When the consumer asks an AI \"which is the best digital account for someone who travels?\" instead of typing the same question into Google, three things change at once: the intermediary between brand and customer becomes a language model, the answer becomes a single recommendation instead of a results page, and the decision of which brand shows up depends on criteria no one yet knows how to bid on."),
        p("There is a growing asymmetry between human search and agent-mediated search. Humans get tired, compare three or four options, choose based on what's most visible. Agents process dozens of sources in seconds, weigh reputation, cross-reference contract terms, and return a recommendation. As this difference becomes obvious to more consumers, more decisions migrate to the conversational interface. This is not projection: recent McKinsey research shows that financial institutions that mastered optimization for these models — a new discipline called Generative Engine Optimization, or GEO — saw up to sixfold growth in unpaid organic traffic."),
        quote(

export const cases = [
  ...
  {
    slug: "agente-diagnostico-gap-seo-geo",
    title: { pt: "Caso 3: Agente de Diagnóstico de Gap SEO x GEO", en: "Case 3: Agent for Diagnosis of SEO x GEO Gaps" },
    desc: {
      pt: "Agente de IA autônomo que identifica gap na participação de uma marca nas buscas tradicionais vs. LLMs e traz hipóteses de oportunidades",
      en: "An autonomous AI agent that detects disparities in Brand Share of Voice between traditional search engines and LLMs, generating hypotheses for new opportunities.",
    },
    tools: ["Python", "Claude Agent SDK", "APIs"],
    sector: { pt: "Growth Marketing", en: "Growth Marketing" },
    status: "coming-soon",
    body: { pt: [], en: [] },
    institutions: [],
  },
